...
def ICC():
	try:
		...
		if in_d:
			print(colored("проверка обновы...", "green"))
			time.sleep(0.7)
			result = r.get("https://github.com/dzeff9827/EkZbomb3r/blob/master/tools/version.txt")
			...
			if last_ver != current_ver and platform != "win32":
				clear()
				print(colored("[!]", "magenta"), colored("Найдено новое обновление", "green"),
					  colored(last_ver, "cyan") + colored("!", "green"))
				print("")
				print(colored("Желаете ли вы обновить до актуальной версии?", "yellow"))
				print("")
				...
				while True:
					...
					if how == "1":
						clear()
						print(colored("Устанавливается архив...", "green"))
						if platform == "linux" or platform == "linux2" or platform == "unix":
							os.chdir("/data/data/com.termux/files/home")
							os.system("rm -rf EkZbomb3r")

							result = r.get("https://github.com/dzeff9827/EkZbomb3r/archive/refs/heads/master.zip")

							a = open("EkZbomb3r.zip", "wb")
							a.write(result.content)
							a.close()

							print(colored("Распаковка архива...", "green"))

							fantasy_zip = zipfile.ZipFile("EkZbomb3r.zip")
							fantasy_zip.extractall("EkZbomb3r")
							fantasy_zip.close()
							os.system("rm -rf EkZbomb3r.zip")

							os.chdir("EkZbomb3r")
							os.chdir("EkZbomb3r-master")

							get_files = os.listdir(os.getcwd())

							for g in get_files:
								shutil.move(g, "/data/data/com.termux/files/home/EkZbomb3r")
							os.chdir("/data/data/com.termux/files/home/EkZbomb3r")
							os.system("rm -rf EkZbomb3r-master")

							print(colored("Обновление прошло успешно, запуск EkZbomb3r...", "green"))
							time.sleep(1.5)

							os.system("python Install.py")
							os.system("python EkZbomber.py")
							exit()
						elif platform == "win32":
							pass
					elif how == "2":
