...
def disclaimer():
	clear()
	print("")
	print(colored("Разработчик не несет ответственность за доставленный моральный или физический ущерб вашей жертве.", "red"))
...
def start_input():
	...
	if pr != None:
		while True:
			...
			print("└"+colored("Общедоступный прокси используют все пользователи omber", "cyan"))
			print("")
